...
;; errors are poetic elisions or other pronunciation variants as
...
;; a major change.
 ...
 (defvar poetry-version-no "0.16 alpha")

;; 2025-07-07 0.16 Added fix to make work properly in txt mode files.
;;                 Added note about adding -fpermissive when building
;;                 the 'rhyme' package.
;;                 An update after another 4 1/2 years!  Over 10 years
;;                 since original coding.  Time flies.
;; 2021-01-24 0.15 Changed http fetches to https. Obrigado to Vagner
;;                 Rener for suggesting this. An update after 4 1/2
;;                 years!
...
;; and libgdm. You know what to do.  Note that as of (at least) 2025,
;; the latest gcc compilers will require the addition of -fpermissive
